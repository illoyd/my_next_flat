...
describe SearchesController do
  ...
  let(:valid_attributes) { { "name" => "MyString", "user_id" => user.id, "locations_attributes" => [location_attributes], "criterias_attributes" => [criteria_attributes] } }
  let(:location_attributes) { { "area" => Faker::Address.city } }
  let(:criteria_attributes) { { "type" => BuyCriteria.name } }
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested search" do
        ...
        Search.any_instance.should_receive(:update).with({ "name" => "MyString" })
